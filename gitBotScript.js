...
function appendBotSpeechBubble(botStr) {
    ...
    var BotBubbleHTML = '<div class="msgWrapper"><div class="avatarImg"><img src="bot_icon.png" alt="Bot avatar" width="55" height="55" /></div><div class="timeStamp">13:54</div><div class="bot-bubble tri-right round btm-left slide-left" id="bubble' + BubbleNumber.toString() + '"><div class="talktext1"><p>' + botStr.toString() + "</p>/div></div></div></div>";
